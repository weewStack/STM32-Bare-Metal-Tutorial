...
// Step 2
// Function to Enable the GPIO, Based on the Port

// Step 3
// Function to Select the Port to be enabled and return it

// Step 4 
// Function to Setup the Pin Mode
